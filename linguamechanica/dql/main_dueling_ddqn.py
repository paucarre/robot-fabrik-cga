...
class Environment:
    def __init__(self, open_chain):
        ...
        """
        self.observation_space = np.zeros(6 + 6 + 1)
        self.action_space = 1
    ...
    def observation_to_numpy(self, observation):
        ...
        observation_np[12] = observation["current_parameter_index"]
    ...
    def compute_reward(self):
        # TODO: compute error using log
        return 1.0 / (
            1.0 + torch.abs(self.current_parameters - self.target_parameters).sum()
        )
